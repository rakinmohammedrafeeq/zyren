        ...
        >
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              <span>Created {new Date(paste.createdAt).toLocaleDateString('en-US', { 
                month: 'short', 
                day: 'numeric', 
                year: 'numeric',
                hour: '2-digit',
              ...
              {paste.expiryAt && (
                <>
                  <span>•</span>
                  <span>Expires {new Date(paste.expiryAt).toLocaleDateString('en-US', {
                    month: 'short',
                    day: 'numeric', 
                    year: 'numeric',
                    hour: '2-digit',
            ...
            >
              <div className="text-center space-y-4 p-8 rounded-xl bg-muted/30 backdrop-blur-sm border border-border/40">
                <p className="text-sm text-muted-foreground">
                  Want to create and share your own pastes?
                </p>
                <Link to="/login">
